...
@Disabled
@TeleOp
public class Example_Pipline extends LinearOpMode
{
   ...
   // This is how we identify our webcam
    ...
    // Creating a pipeline to use later (examplePipline is the function at the bottom of this file)
    examplePipline pipeline;
    ...
    public void runOpMode()
    {
        ...
        {
            // in the initialization, it well tell you the position of what the camera
            // thinks has the most amount of whatever your COI is.
    ...
    public static class examplePipline extends OpenCvPipeline
    {
       ...
       // Colors that you will use to make the rectangles - Technically it doesn't matter what color
        ...
        void inputToCb(Mat input)
        {
            ...
            // THE COI is the category that you choose to detect colors in
