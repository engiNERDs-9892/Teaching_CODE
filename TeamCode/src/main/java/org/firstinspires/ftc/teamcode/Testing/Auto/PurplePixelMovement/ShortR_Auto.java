...
public class ShortR_Auto extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence POSITIONM = drive.trajectorySequenceBuilder(new Pose2d(0,0, Math.toRadians(90)))
        ...
        TrajectorySequence POSITIONR = drive.trajectorySequenceBuilder(new Pose2d(0,0, Math.toRadians(90)))
                .UNSTABLE_addTemporalMarkerOffset(0,() -> {
                    PurplePixelServo.setPosition(DropPurplePixel * DegreeTorque);
                })
                .build();
        ...
        TrajectorySequence POSITIONL = drive.trajectorySequenceBuilder(new Pose2d(0,0, Math.toRadians(90)))
                .UNSTABLE_addTemporalMarkerOffset(0,() -> {
                    PurplePixelServo.setPosition(DropPurplePixel * DegreeTorque);
                })
                .build();

        TrajectorySequence POSITIONUNKNOWN = drive.trajectorySequenceBuilder(new Pose2d(0,0, Math.toRadians(90)))
                .build();
